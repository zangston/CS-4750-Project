...
$username = 'kjk5drb_b';  // kjk5drb_a, kjk5drb_b, kjk5drb_c
$password = 'Fall2023';
$host = 'mysql01.cs.virginia.edu';
$dbname = 'kjk5drb';
$dsn = "mysql:host=mysql01.cs.virginia.edu;dbname=kjk5drb";
////////////////////////////////////////////
...
//  $db = new PDO("mysql:host=$hostname;dbname=db-demo", $username, $password);
   ...
   // echo "<p>You are connected to the database: $dsn</p>"; // comment this out
}
